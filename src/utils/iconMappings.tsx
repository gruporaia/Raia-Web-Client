...
export const CATEGORY_ICONS: Record<string, typeof SvgIcon> = {
  ...
  'Modelos de IA': PsychologyIcon,
  'Modelos de Inteligencia Artificial': PsychologyIcon,
  ...
  'Procesamiento de Lenguaje Natural': ChatIcon,
  'Processamento de Texto': ChatIcon,
  'Procesamiento de Texto': ChatIcon,
  'Text-to-speech': ChatIcon,
  'Text-to-Speech': ChatIcon,
  'Texto a voz': ChatIcon,
  'AI Agents': PsychologyIcon,
  'Agentes de IA': PsychologyIcon,
  NLP: ChatIcon,
  RAG: ChatIcon,
